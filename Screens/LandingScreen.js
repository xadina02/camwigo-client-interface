...
import { SafeAreaView, Text, Image, ScrollView, View, StyleSheet, StatusBar } from 'react-native';
...
const LandingScreen = () => {
  ...
  useEffect(() => {
    setActiveTab('Home'); // Set the active tab to 'Home' when this screen is rendered
  }, [{activeTab}]);
            ...
            <View style={styles.another}>
                <View style={styles.header}>
                        <View>
                            ...
                            <Text style={styles.headerSubText}>No stress, travel easy..</Text>
                        </View>
